...
COMMENT ON COLUMN "BOARD"."BOARD_DEL_FL" IS '삭제 여부(N:삭제 X, Y:삭제O)';

COMMENT ON COLUMN "BOARD"."MEMBER_NO" IS '작성자 회원 번호';

COMMENT ON COLUMN "BOARD"."BORAD_CODE" IS '게시판 코드 번호';
...
COMMENT ON COLUMN "BOARD_IMG"."IMG_PATH" IS '이미지 저장 폴더';
...
VALUES(SEQ_MEMBER_NO.NEXTVAL, 'user02@kh.or.kr', 'pass02!', 
	'이번유저', '01056785678', '04540,,서울시 중구 남대문로 120,,15층',
	DEFAULT, DEFAULT, DEFAULT, DEFAULT
);
...
UPDATE "MEMBER" SET
MEMBER_NICKNAME = '변경된 닉네임', MEMBER_TEL ='01029384757', MEMBER_ADDRESS ='12345,,서울시어딘가,,88'
WHERE MEMBER_NO=4;
			-- 로그인한 회원의 번호 
...
UPDATE "MEMBER" SET 
MEMBER_PW ='$2a$10$lf31pRQlGmXOcronqLH9E.W1JlG3RypFmWZqlYZrF4ceN/nTe43Ie';
